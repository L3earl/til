...
- [분석 일반](#분석-일반)
- [DataCamp_Data Scientist with R](#DataCamp_Data-Scientist-with-R)
- [LGU+빅데이터 Basic 과정](#LGU+빅데이터-Basic-과정)
...
## [DataCamp_Data Scientist with R](https://www.datacamp.com/tracks/data-scientist-with-r)
- [Introduction to R](https://www.datacamp.com/courses/free-introduction-to-r)  
- [Intermediate R](https://www.datacamp.com/courses/intermediate-r)  


## [LGU+빅데이터 Basic 과정]
- [1일](machine_learning/LGU+Basic/1st.md)
